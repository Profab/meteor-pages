...
+ **divWrapper (*String, default = "pageCont")** - if it's specified and table mode is not enabled, the Pagination page is wrapped in a div with the provided class name. Pass an empty string to disable the div wrapper.
